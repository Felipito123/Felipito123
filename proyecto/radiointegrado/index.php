...
<body style="background-color: #222;">
    ...
    <div class="container p-2">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <!-- .main-header -->
                <header class="pt-4 m-1" style="background-image: url('img/onair.jpg');background-repeat: no-repeat;background-position:center;height: 15vh;">
                    <!-- <div class="row justify-content-center text-center"  >
                        <div class="col-lg-12" >
                            <img class="img-fluid p-4" src="img/9.jpg" alt="BioBio - La Radio">
                        </div>
                    </div> -->
                </header><!-- /.main-header -->
            </div>
        ...
        <div class="row m-1 pb-4" style="background-image: url('img/radiofondo.jpg');background-repeat: no-repeat;background-position:center;height: 50vh;">

            <div class="col-lg-12 text-center">
                <label id="estado" style="color:white;position: absolute;top: 0;top:15;left: 9;font-size: 16px;font-size: 1rem;padding: 7px 10px;background-color: rgba(0, 0, 0, 0.5);font-weight: 500; border-radius: 6px;">EN VIVO</label>
        ...
        <div class="row justify-content-center m-1 pb-4" style="background-color: #f44336;">
            ...
            <div class="container pt-3">
                <div class="row justify-content-center pb-3">
                    <div class="col-xl-4 pr-5 pl-5 m-2">
                        <select name="frequencias" id="frequencias" class="form-control">
                            <option value="https://node-21.zeno.fm/dpw32qp5xbruv?rj-ttl=5&rj-tok=AAABfDVQvsgAx_aVsMkZX25nxA, Radio Aylen (Los Álamos)">Radio Aylen</option>
                            ...
                            <option value="https://node-19.zeno.fm/v3nmg3rqxmzuv?rj-ttl=5&rj-tok=AAABfDVYkBYAidBVnkCK8XIJpw, Radio Ensueños (Temuco chico - Los Álamos)">Radio Ensueños</option>
                            <option value="https://22823.live.streamtheworld.com/CORAZON_SC, Radio Corazón 101.3">Radio Corazón 101.3</option>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-6">
                        <audio id="sonido" title="Reproductor de Radio" style="display: block;" autoplay controls preload="none">
    ...
    <script>
        ...
        let obtengoprimervalorselect = $('#frequencias').get(0).value;
        let separar = obtengoprimervalorselect.split(',');
        $("#tituloradio").text(separar[1]);
        $("#sonido").attr("src", separar[0]);
        audio.load();
        audio.play();

        // console.log("Valor: " + au);
