		...
		messages: {
			...
			en: {
				...
				float: {
					...
					incorrect: 'Número Flotante incorrecto'
				},
				min: {
					empty: 'Ingrese más',
				...
				between: {
					empty: 'Ingrese entre {0}-{1}',
					incorrect: 'Ingrese entre {0}-{1}'
				},
				name: {
				...
				length: {
					...
					incorrect: 'Incorrect. Ingrese un mínimo de {0} caracteres y un máximo de {1}'
				},
				minlength: {
					empty: 'Por favor, ingrese más caracteres',
				...
				maxfilesize: {
					empty: 'El tamaño de uno o más archivos seleccionados mayor que {0} {1}',
					incorrect: 'El tamaño de uno o más archivos seleccionados mayor que {0} {1}'
				},
				fileextension: {
