...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column ">
            ...
            <div id="content">
                ...
                <div class="container-fluid" style="padding-bottom:10%;">
                        ...
                        <div class="col-xl-2 col-sm-12 pt-4 pb-4" id="tarjeta3">
                            <div class="card rounded shadow-sm">
                                <div class="card-body text-center card-img-top p-4">
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-lg-12">
                                            <h2 class="pb-2">Mi Cuenta Personal</h2>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    if (isset($_GET['sr']) && !empty($_GET['sr']) && $_GET['sr'] == 'sr' && isset($_GET['cd'])) {
                        echo '<script>alertify.error("La solicitud con código ' . $_GET['cd'] . ' fue rechazada");</script>';
                    } else if (isset($_GET['errcd']) && !empty($_GET['errcd']) && $_GET['errcd'] == '1' && isset($_GET['cd'])) {
                        echo '<script>alertify.error("Ha ocurrido un error al mostrar la solicitud con código: ' . $_GET['cd'] . '.Si el problema persiste, contacte a soporte.");</script>';
                    } else if (isset($_GET['errcd']) && !empty($_GET['errcd']) && $_GET['errcd'] == '2' && isset($_GET['cd'])) {
                        echo '<script>alertify.error("No hay solicitudes asociadas al código de solicitud: ' . $_GET['cd'] . '.");</script>';
                    } else if (isset($_GET['errcd']) && !empty($_GET['errcd']) && $_GET['errcd'] == '3' && isset($_GET['cd'])) {
                        echo '<script>alertify.error("No se han recibido parámetros para buscar.");</script>';
                    }
                    ?>
    ...
    <script>
        ...
        url = url.split('?')[0];
        history.pushState({}, "removed the id", url);
    </script>
