...
<title>Salud los Álamos - Permiso Administrativo</title>
</head>
...
<body id="page-top">
    ...
    <div id="wrapper">
                            ...
                            <div class="col-lg-4 col-md-6 mb-lg-0">
                                ...
                                <div class="card rounded shadow-sm border-0">
                                    <div class="card-body p-0">
                                        <div class="bg-<?php echo $temadelacookie; ?> px-5 py-3 text-center card-img-top"><span class="mb-2 d-block mx-auto"><i class="icofont-ebook" style="font-size: 55px;color:white;"></i></span>
                                            <h5 class="text-white mb-0">Permiso Administrativo</h5>
                    ...
                    <div class="row justify-content-center pt-4">
                        ...
                        <div class="col-lg-7 pb-3">
                            ...
                            <div class="card border-left-<?php echo $temadelacookie; ?>">
                                <div style="padding: 4%;">
                                    <form id="formRegistrarPermisoAdministrativo" method="POST" autocomplete="off">
                                        ...
                                        ?>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    $sqltipodia = "SELECT id_tiporem, descripcion_tiporem FROM tipo_remuneracion";
                                                    $consultatipodia = mysqli_query($mysqli, $sqltipodia);
                                                    ...
                                                    ?>
                                                        <div class="form-group">
                                                            <label id="labelparaswal">Caracteristica del Permiso:</label>
                                                            <div class="input-group mb-3">
                                                                <span class="input-group-text"><i class="fas fa-file-invoice-dollar" aria-hidden="true" style="width: 13px;"></i></span>
                                                                <select class="form-control" id="tipo_degoce" name="tipo_degoce" required>
                                                                    <option value="">Seleccione tipo de goce...</option>
                                                                    <?php

                                                                    while ($fila1 = mysqli_fetch_array($consultatipodia)) {
                                                                        $ID_TIPO_DIA = $fila1['id_tiporem'];
                                                                        $DESCRIPCION_TIPO_DIA = $fila1['descripcion_tiporem'];
                                                                        echo '<option value="' . $ID_TIPO_DIA . '">' . $DESCRIPCION_TIPO_DIA . '</option>'; //utf8_encode($NOMBRE_CATEGORIA)
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                        ...
                                        <div class="row justify-content-center">
                                            <div class="col-lg-6">
                                                ...
                                                $sqltipodia = "SELECT id_tipo_dia, descripcion_tipo_dia FROM tipo_dia";
                                                $consultatipodia = mysqli_query($mysqli, $sqltipodia);
                                                ...
                                                ?>
                                                    <div class="form-group">
                                                        <label id="labelparaswal">Dia(s):</label>
                                                        <div class="input-group mb-3">
                                                            <span class="input-group-text"><i class="fas fa-sun" aria-hidden="true" style="width: 13px;"></i></span>
                                                            <select class="form-control" id="tipo_dia" name="tipo_dia" required>
                                                                <option value="">Seleccione el tipo de dia...</option>
                                                                <?php

                                                                while ($fila1 = mysqli_fetch_array($consultatipodia)) {
                                                                    $ID_TIPO_DIA = $fila1['id_tipo_dia'];
                                                                    $DESCRIPCION_TIPO_DIA = $fila1['descripcion_tipo_dia'];
                                                                    echo '<option value="' . $ID_TIPO_DIA . '">' . $DESCRIPCION_TIPO_DIA . '</option>'; //utf8_encode($NOMBRE_CATEGORIA)
                                                                }
                                                                ?>
                                                            </select>
                                            ...
                                            <?php /*calcular el año actual para obtener el max del input type date:*/ $fechamaxima = $anoactual . "-12" . "-31"; ?>
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <input type="date" class="form-control" id="fecha_permiso" name="fecha_permiso" placeholder="Ingrese fecha de nacimiento" onkeypress="return fechausuarios(event)" minlength="10" maxlength="10" min='<?php echo $fechadehoy; ?>' max='<?php echo $fechamaxima; ?>' onpaste="return false" required>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row justify-content-center" id="divfirma">
                                            <div class="col-lg-12">
                                                <div class="form-group">
                                                    ...
                                                    <!--OTROS TIPOS DE EXTENSIONES DE IMAGENES: image/jpg, image/jpeg,image/bmp -->
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    <label id="labelparaswal">Motivo</label>
                                                    <div class="input-group mb-3">
                                                        <!-- <span class="input-group-text"><i class="fas fa-paragraph" aria-hidden="true" style="width: 13px;"></i></span> -->
                                                        <textarea class="form-control" id="motivo" name="motivo" placeholder="Motivo del permiso" rows="3" col="10" minlength="4" maxlength="1000" onkeypress="return soloCaractDeConversacion(event)" onpaste="return false" style="resize: none;" autocomplete="off" required></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row justify-content-center" id="divSiHaySolicitudes">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group ">
                                                    <label class="btn btn-danger form-control col-3" for="buscarpermiso"><i class="icofont-ebook" style="font-size: 25px;color:white;"></i></label>
        ...
        <script>
            $("#permisoadministrativo").attr('class', 'nav-item active');
        </script>
        ...
        <script src="js/permisoadmin.js"></script>
