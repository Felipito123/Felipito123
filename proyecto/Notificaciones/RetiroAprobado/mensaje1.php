...
<head>
	...
	<title>Aprobado de medicamentos</title>
</head>
								...
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" style="background-color: rgb(255, 255, 255); box-shadow: rgb(216, 216, 216) 0px 0px 10px;" width="100%" class="tableCard">
										...
										<tbody>
											<tr>
												<!-- Header Top Border // -->
												<td height="3" style="background-color: #01c5c4; font-size: 1px; line-height: 4px;" class="topBorder">&nbsp;</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding-bottom: 20px;" class="imgHero">
													...
													<a href="javascript:void(0)" style="text-decoration:none;">
														<img src="https://valueless-teller.000webhostapp.com/NotificacionesCesfam/retiromedicamentoaprobado.jpg" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;">
													</a>
												</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" class="mainTitle">
													<!-- Main Title Text // -->
													<h2 class="text" style="color:#01c5c4; font-family:Poppins, Helvetica, Arial, sans-serif; font-size:28px; font-weight:700; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">
													SOLICITUD RETIRO <br> DE MEDICAMENTO <strong>APROBADA<strong>
													</h2>
												</td>
											</tr>
															...
															<tr>
																<td align="center" valign="top" style="padding-bottom: 20px;" class="description">
																	...
																	<p class="text" style="color:#666666; font-family:Open Sans, Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
																		La solicitud con fecha ' . $fechaderetiro . ' ha sido aprobada como nuevo horario del mes en curso.
																		Acércate a la ventanilla de Farmacia para que puedes retirar tu(s) medicamento(s).
																	</p>
																</td>
															</tr>
														</tbody>
															...
															<tr>
																<td align="center" valign="top" style="padding-top:20px;padding-bottom:20px;">
																	...
																	<table align="center" border="0" cellpadding="0" cellspacing="0">
																		<tbody>
																			<tr>
																				<td align="center" class="ctaButton" style="background-color: #01c5c4; padding: 12px 35px; border-radius: 50px;">
																					<!-- Button Link // -->
