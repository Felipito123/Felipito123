...
<head>
	...
	<title>Retiro de medicamentos</title>
</head>
		...
		<tbody>
			<tr>
				<td align="center" valign="top" style="padding-right:10px;padding-left:10px;" id="bodyCell">
					...
					<table border="0" cellpadding="0" cellspacing="0" style="max-width:600px;padding-top:10px;" width="100%" class="wrapperBody">
						<tbody>
							<tr>
								<td align="center" valign="top">

									<!-- Table Card Open // -->
									<table border="0" cellpadding="0" cellspacing="0" style="background-color: rgb(255, 255, 255); box-shadow: rgb(216, 216, 216) 0px 0px 10px;" width="100%" class="tableCard">

										<tbody>
											<tr>
												<!-- Header Top Border // -->
												<td height="3" style="background-color: rgb(195 110 79); font-size: 1px; line-height: 4px;" class="topBorder">&nbsp;</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding-bottom: 20px;" class="imgHero">
													...
													<a href="javascript:void(0)" style="text-decoration:none;">
														<img src="https://valueless-teller.000webhostapp.com/NotificacionesCesfam/fondoagendamedica.jpg" width="600" alt="" border="0" style="width:100%; max-width:600px; height:auto; display:block;">
													</a>
												</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" class="mainTitle">
													<!-- Main Title Text // -->
													<h2 class="text" style="color:#c36e4f; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:28px; font-weight:700; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">
											...
											<tr>
												<td align="center" valign="top" style="padding-top: 10px;padding-bottom: 17px; padding-left: 20px; padding-right: 20px;" class="subTitle">
													...
													<h4 class="text" style="color:#999999; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:16px; font-weight:500; font-style:normal; letter-spacing:normal; line-height:24px; text-transform:none; text-align:center; padding:0; margin:0">
														...
														Cuenta de paciente validada ✅ </h4>
												</td>
											</tr>
															...
															<tr>
																<td align="center" valign="top" style="padding-bottom: 20px;" class="description">
																	...
																	<p class="text" style="color:#666666; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:14px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:22px; text-transform:none; text-align:center; padding:0; margin:0">
																		Hemos recibido tu nuevo horario de retiro de medicamentos.
																		<br>
																		Una vez revisado por el personal encargado, recibirás la confirmación de tu solicitud para que puedas despacharlo en ventanilla de Farmacia el día anteriormente 👆 mencionando.
																	</p>
																</td>
															</tr>
														</tbody>
															...
															<tr>
																<td align="center" valign="top" style="padding-top:20px;padding-bottom:20px;">
																	...
																	<table align="center" border="0" cellpadding="0" cellspacing="0">
																		<tbody>
																			<tr>
																				<td align="center" class="ctaButton" style="background-color: rgb(195 110 79); padding: 12px 35px; border-radius: 50px;">
																					<!-- Button Link // -->
																					<a class="text" href="javascript:void(0);" style="color:#FFFFFF; font-family:'Poppins', Helvetica, Arial, sans-serif; font-size:13px; font-weight:600; font-style:normal;letter-spacing:1px; line-height:20px; text-transform:uppercase; text-decoration:none; display:block">
																						🕑 Fecha Agendada:  17/12/2021
																					</a>
																				</td>
																			</tr>
																		</tbody>
							...
							<tr>
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%" class="footer">
										<tbody>
											<tr>
												<td align="center" valign="top" style="padding-top:7px;padding-bottom:10px;padding-left:10px;padding-right:10px;" class="socialLinks">
													<!-- Social Links (Facebook)// -->
													<a href="https://web.facebook.com/Salud-Los-%C3%81lamos-282022055557052/?_rdc=1&_rdr" target="_blank" style="display: inline-block;" class="facebook">
													...
													<a href="https://twitter.com/CESFAMLA?s=20" target="_blank" style="display: inline-block;" class="twitter">
									...
									<img src="http://weekly.grapestheme.com/notify/img/social/light/instagram.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px">
													...
													<a href="https://www.youtube.com/channel/UCVQo4luAgqmuZ_t3wgs-A8A" target="_blank" style="display: inline-block;" class="linkdin">
														<img src="http://weekly.grapestheme.com/notify/img/social/light/youtube.png" alt="" width="40" border="0" style="height:auto; width:100%; max-width:40px; margin-left:2px; margin-right:2px">
													</a>
												</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding: 10px 10px 5px;" class="brandInfo">
													<!-- Brand Information // -->
													<p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">©&nbsp; CESFAM. | Calle Pedro Eyheramendy 835 | Los álamos, BíoBio, Chile. </p>
												</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding: 0px 10px 10px;" class="footerEmailInfo">
													...
													<p class="text" style="color:#777777; font-family:'Open Sans', Helvetica, Arial, sans-serif; font-size:12px; font-weight:400; font-style:normal; letter-spacing:normal; line-height:20px; text-transform:none; text-align:center; padding:0; margin:0;">
														...
														Si tienes alguna duda contáctanos <a href="http://localhost/tesisactual/proyecto/contacto/" style="color:#777777;text-decoration:underline;" target="_blank">Página web.</a>
