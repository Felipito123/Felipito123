...
<![endif]-->
  ...
  <!--<![endif]-->
  <title>Recepcion Libro RSF</title>
                          ...
                          <tr>
                            <td style="overflow-wrap:break-word;word-break:break-word;padding:2px 40px 25px;font-family:Open Sans,sans-serif;" align="left">
                              ...
                              <div class="v-text-align" style="color: #7a7676; line-height: 170%; text-align: left; word-wrap: break-word;">
                                ...
                                <p style="font-size: 14px; line-height: 170%; text-align: center;"><span style="font-size: 16px; line-height: 27.2px;">Gracias por contactarnos, su ' . $tiposolicitud . ' fue registrado de manera exitosa en nuestro Sistema  con fecha <strong> ' . $fechahoy . ' </strong>.</span></p>
                              </div>
