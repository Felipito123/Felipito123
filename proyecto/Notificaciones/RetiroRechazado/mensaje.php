								...
								<td align="center" valign="top">
									...
									<table border="0" cellpadding="0" cellspacing="0" style="background-color: rgb(255, 255, 255); box-shadow: rgb(216, 216, 216) 0px 0px 10px;" width="100%" class="tableCard">
										...
										<tbody>
											<tr>
												<!-- Header Top Border // -->
												<td height="3" style="background-color: #e74a3b; font-size: 1px; line-height: 4px;" class="topBorder">&nbsp;</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" class="mainTitle">
													<!-- Main Title Text // -->
													<h2 class="text" style="color:#e74a3b; font-family:Poppins, Helvetica, Arial, sans-serif; font-size:28px; font-weight:700; font-style:normal; letter-spacing:normal; line-height:36px; text-transform:none; text-align:center; padding:0; margin:0">
														SOLICITUD RETIRO <br> DE MEDICAMENTO <strong>RECHAZADA<strong> 
													</h2>
												</td>
											</tr>
											...
											<tr>
												<td align="center" valign="top" style="padding-left:20px;padding-right:20px;" class="containtTable ui-sortable">
													...
													<table border="0" cellpadding="0" cellspacing="0" width="100%" class="tableDescription" style="">
														<tbody>
															<tr>
																<td align="center" valign="top" style="padding-bottom: 20px;padding-top: 20px;" class="description">
																	<!-- Description Text// -->
															...
															<tr>
																<td align="center" valign="top" style="padding-top:20px;padding-bottom:20px;">
																	...
																	<table align="center" border="0" cellpadding="0" cellspacing="0">
																		<tbody>
																			<tr>
																				<td align="center" class="ctaButton" style="background-color: #e74a3b; padding: 12px 35px; border-radius: 50px;">
																					<!-- Button Link // -->
