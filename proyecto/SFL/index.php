...
if (isset($_SESSION['sesionCESFAM']) && ($rol == 7 || $rol == 8 ||  $rol == 11 || $rol == 12 || $rol == 13 || $rol == 15)) { //VALIDA QUE SÓLO PUEDE VER ESTA PANTALLA EL SUPERADMIN Y EL DE FARMACIA
    //puede entrar el Director, encargado de personal, Jefe sistema salud
...
<title>Salud los Álamos - Solicitud de feriado legal</title>
...
<style>
    ...
    .bg_verdeFeriadoLegal {
        background-color: #267b74;
    }

    .btn_verdeFeriadoLegal {
        background-color: #267b74;
        color: #ffffff;
    }

    .btn_verdeFeriadoLegal:hover {
...
<body id="page-top">
    ...
    <div id="wrapper">
                        ...
                        <div class="col-lg-3 col-md-6 mb-lg-0 pl-4">
                            ...
                            <div class="card rounded shadow-sm border-0">
                                <div class="card-body p-0">
                                    <div class="bg_verdeFeriadoLegal px-3 py-1 pt-3 pb-3 text-center card-img-top"><span class="mb-2 d-block mx-auto"><i class="icofont-legal" style="font-size: 55px;color:white;"></i></span>
                                        <p class="text-white mb-0">Solicitudes De Feriado Legal (SFL)</p>
                                        <p class="small text-white mb-0">En esta sección, puedes visualizar las <br> solicitudes de feriado legal emitida por un funcionario.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <!--<span>Filtrar</span>-->
                                                    <label class="btn btn_verdeFeriadoLegal form-control col-sm-4" for="filtrador" title="Filtrar"><i class="fas fa-filter"></i> </label>
        ...
        <script>
            $("#solicituddeferiadolegal").attr('class', 'nav-item active');
        </script>
        ...
        <script src="js/tabla_soli_SFL.js"></script>
