<!--Modal CALIDAD -->
<div class="modal fade" id="modalarchivocalidad" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                        <iframe id="framecalidad" src="" frameborder="0" scrolling="no" width="100%" height="500px"></iframe>
                    </div>
                </div>
            </div>
