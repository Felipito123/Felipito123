<!--Modal DOCUMENTO -->
<div class="modal fade" id="modal-mostrar-documento" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row justify-content-center">
                            <iframe id="framedocumento" src="" frameborder="0" scrolling="no" width="100%" height="500"></iframe>
                    </div>
