...
CREATE TABLE IF NOT EXISTS `tesis`.`tipo_paciente` (
  `id_tipo_paciente` INT NOT NULL AUTO_INCREMENT,
  `nombre_tipo_paciente` VARCHAR(100) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tesis`.`medicamento` (
  ...
  `precio_medicamento` VARCHAR(7) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `tesis`.`historial_medicamento` (
  ...
  INDEX `fk_historial_medicamento_estado_medicamento1_idx` (`estado_medicamento` ASC) ,
  ...
  CONSTRAINT `fk_historial_medicamento_estado_medicamento1`
    FOREIGN KEY (`estado_medicamento`)
...
CREATE TABLE IF NOT EXISTS `tesis`.`paciente` (
  ...
  INDEX `fk_paciente_tipo_paciente1_idx` (`tipo_paciente` ASC) ,
  CONSTRAINT `fk_paciente_tipo_paciente1`
    FOREIGN KEY (`tipo_paciente`)
    REFERENCES `tesis`.`tipo_paciente` (`id_tipo_paciente`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `tesis`.`historial_solicitud` (
  `id_historial_solicitud` INT NOT NULL,
  `id_medicamento` INT NOT NULL,
  ...
  CONSTRAINT `fk_medicamento_has_solicitud_medicamento_solicitud_medicamento1`
    ...
    REFERENCES `tesis`.`solicitud_medicamento` (`id_solicitud_medicamento`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
