...
CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`permiso_feriado_legal` (
...
CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`autoriza` (
  ...
  CONSTRAINT `fk_autoriza_permiso_feriado_legal1`
    FOREIGN KEY (`id_pfl`)
    REFERENCES `saludlosalamos2`.`permiso_feriado_legal` (`id_pfl`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
DEFAULT CHARACTER SET = utf8;

CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`prorroga` (
...
CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`solicitud_feriado_legal` (
  ...
  CONSTRAINT `fk_solicitud_feriado_legal_etapas_sfl1`
    ...
    REFERENCES `saludlosalamos2`.`etapas_sfl` (`id_etapas_sfl`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_solicitud_feriado_legal_decision_sfl1`
    FOREIGN KEY (`id_decision_sfl`)
    REFERENCES `saludlosalamos2`.`decision_sfl` (`id_decision_sfl`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`eventos` (
  ...
  CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`destinatarios_eventos` (
  ...
  CONSTRAINT `fk_usuario_has_eventos_eventos1`
    ...
    REFERENCES `saludlosalamos2`.`eventos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
DEFAULT CHARACTER SET = utf8;
 ...
 CREATE TABLE IF NOT EXISTS `saludlosalamos2`.`destinatario_reunion` (
  ...
  CONSTRAINT `fk_reunion_has_usuario_reunion1`
    ...
    REFERENCES `saludlosalamos2`.`reunion` (`id_reunion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
